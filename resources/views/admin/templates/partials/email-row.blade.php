    ...
    <td class="text-end">
        <div class="d-inline-flex gap-2">
            <button
                ...
                data-method="PUT"
                data-record='@json(['tenant_id' => $template->tenant_id, 'type' => $template->type, 'name' => $template->name, 'subject' => $template->subject, 'body' => $template->body, 'is_active' => $template->is_active])'
            >
                Editar
            </button>
            <button
